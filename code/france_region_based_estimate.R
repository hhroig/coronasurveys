...
get_france_region_based_rosa <- function(max_ratio = .3, write_file = T){
  cat("generating region based estimate for France \n")
...
get_france_region_based_rosa(write_file = T)