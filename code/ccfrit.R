...
populationIT<-60431283
survey_twitter<-rep(NaN,size)
survey_gforms<-rep(NaN,size)

#position 92 is March 31 results about March 30 cases

survey_twitter[81]<-(238.26/(377*150))*populationIT #19 Mar

survey_gforms[88]<-763135 #26 Mar cf=1, pool 3
survey_gforms[90]<-1168869 #28 Mar cf=1, pool 4
survey_gforms[92]<-754109 #30 Mar cf=1, pool 5

#est_ccfr[size]<-data$confirmados[size]*1/fraction_reported

plot(data$obitos*400,log="y",xlim=c(50,size+1), ylim=c(1,10000000),yaxt="n",xaxt="n",type="l",xlab="Days",main="Different estimates of COVID-19 cases in Italy",ylab="Total cases",lty=4)
