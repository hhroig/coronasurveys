...
estimates_pt_pool5 <- estimate_cases(file_path = "../data/PT-05-20200328-20200329.csv", country_population = 10261075, correction_factor = 1)
...
#
estimates_pt_pool5$mean_cases 
estimates_pt_pool5$mean_reach
estimates_pt_pool5$cases_per_reach
estimates_pt_pool5$estimated_cases 
