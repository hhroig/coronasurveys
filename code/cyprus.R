...
estimates_cyprus_pool2 <- estimate_cases(file_path = "../data/CY-02-20200320-20200321.csv", country_population = 1189265-300000)
estimates_cyprus_pool3 <- estimate_cases(file_path = "../data/CY-03-20200323-20200325.csv", country_population = 1189265-300000)
estimates_cyprus_pool4 <- estimate_cases(file_path = "../data/CY-04-20200327-20200328.csv", country_population = 1189265-300000)
estimates_cyprus_pool5 <- estimate_cases(file_path = "../data/CY-05-20200329-20200330.csv", country_population = 1189265-300000)
