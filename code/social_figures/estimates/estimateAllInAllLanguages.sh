...
for language in en; do
	...
	LC_ALL=$language ./estimates_plot.py -ct FR -f 50  -o 10 -cs 35 -ccfr 40 -ccfrtof -8 -cstof -5 -ccfryoff 900000 -csyof 1000000 -helpusoff 95 -oyoff 300000 --cosurerror --logyscale $scale
